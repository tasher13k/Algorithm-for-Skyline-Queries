...
namespace dataset{
    void fill_vector_of_points_with_random_values(vector_type & data) {
        ...
        std::uniform_real_distribution<float> u (constants::min_value_of_coordinate, constants::max_value_of_coordinate);// generates real random number in specified range
